...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { description: @training.description, distance: @training.distance, points: @training.points, training_category_id: @training.training_category_id }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { description: @training.description, distance: @training.distance, points: @training.points, training_category_id: @training.training_category_id }
    assert_redirected_to training_path(assigns(:training))
  end
