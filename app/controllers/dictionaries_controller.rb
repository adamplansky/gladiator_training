class DictionariesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dictionary.save
        format.html { redirect_to new_dictionary_path, notice: 'Pojem byl úspěšně přidán.' }
        format.json { render :new, status: :created, location: @dictionary }
      else
  ...
  private
    ...
    def dictionary_params
      params.require(:dictionary).permit(:en_name, :cz_name, :abr)
    end
end
